...
# Pre-defined configs
##
from omni.isaac.lab_assets.cartpole_triple import CARTPOLE_CFG  # isort:skip
...
class RewardsCfg:
    ...
    pole_pos_triple = RewTerm(
        func=mdp.joint_pos_target_l2,
        weight=-20.0,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["double_to_triple"]), "target": 0.0},
    )
...
@configclass
class CartpoleTripleEnvCfg(ManagerBasedRLEnvCfg):
